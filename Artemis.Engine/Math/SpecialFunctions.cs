...
namespace Artemis.Engine.Math
{
	...
	public static class SpecialFunctions
	{
		...
		**/
        ...
        {
            if (x < 0.0)
                return Digamma(1 - x) + System.Math.PI / System.Math.Tan(System.Math.PI * (1 - x));
            else if (x < 1.0)
        ...
        {
            return Integrator.Simpsons(t => System.Math.Sin(t) / t, 1e-8, x, 1 << 10);
        ...
        public static double CiApprox(double x)
        {
            ...
            // This is the Padé Approximant of Si, given by
            //      https://en.wikipedia.org/wiki/Trigonometric_integral
            return 0.577215664901532861 + System.Math.Log(x)
                + x2 * (-0.25
        ...
        {
            return System.Math.Pow(System.Math.Sin(x), 2.0);
        }
        ...
        {
            return System.Math.Exp(-System.Math.Pow(x, 2.0));
        }
        ...
        {
            return System.Math.Exp(-System.Math.Pow(x, 2.0) - System.Math.Pow(y, 2.0));
        }
        ...
        {
            return System.Math.Log(System.Math.Exp(x) + System.Math.Exp(y));
        }
